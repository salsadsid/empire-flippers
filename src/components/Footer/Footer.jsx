...
const Footer = () => {
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-black">
      <div className="max-w-7xl w-full px-4 text-white flex flex-col">
        <div className="w-full text-7xl font-bold">
          <h1 className="w-full md:w-2/3">How can we help you. get in touch</h1>
        </div>
        <div className="flex mt-8 flex-col lg:flex-row lg:justify-between items-start">
          ...
          <div className="">
            <button
              type="button"
              className="group whitespace-nowrap border border-yellow-500 bg-yellow-500 text-white rounded-md px-[46px] py-4  text-xl flex items-center gap-3 font-semibold transition duration-500 ease select-none hover:bg-yellow-600 focus:outline-none focus:shadow-outline"
            >
              Contact Us
              <BsArrowRight
                size="25"
        ...
        <div className="flex flex-col">
          <div className="flex mt-24 mb-12 flex-row justify-between">
            <Link to="/" className="text-2xl italic font-mono font-semibold">
              Empire Flippers
            </Link>
            ...
            <div className="flex flex-row space-x-8 items-center justify-between">
              <Link to="/" className="hover:bg-slate-600 p-3 rounded-sm">
                <svg
                  width="20"
                  height="15"
                  viewBox="0 0 6 12"
